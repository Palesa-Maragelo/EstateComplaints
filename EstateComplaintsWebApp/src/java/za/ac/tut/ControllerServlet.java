...
import bl.ComplaintFacadeLocal;
...
public class ControllerServlet extends HttpServlet {
    ...
    @EJB private ComplaintFacadeLocal cfl;
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
           ...
           url = "va.jsp";
           }else if(operation.equalsIgnoreCase("givefeedback")){
               Long id = Long.parseLong(request.getParameter("c_id"));
               Long r_id = Long.parseLong(request.getParameter("r_id"));
               Resident r = rfl.find(r_id);
            Complaint c = cfl.find(id);
            request.setAttribute("resident", r);
            request.setAttribute("complaint", c);
           url = "give_feedback.jsp";
           }
           else if(operation.equalsIgnoreCase("savefeedback")){
               Long id = Long.parseLong(request.getParameter("c_id"));
